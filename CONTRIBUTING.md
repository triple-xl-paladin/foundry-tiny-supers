# Contributing to Tiny Supers for Foundry VTT
...
If you find bugs or have ideas for new features, please open an issue on [GitHub Issues](https://github.com/triple-xl-paladin/foundry-tiny-supers/issues).  
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/triple-xl-paladin/foundry-tiny-supers.git
   ```
...
Thanks again for helping out! Together we make the system module better.